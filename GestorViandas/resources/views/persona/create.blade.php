            ...
            <div class="col-md-6 col-md-offset-3">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="table-container content centered">
                            <form method="POST" action="{{ route('persona.store') }}"  role="form">
                                ...
                                <div class="row">
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <input type="text" name="apellido" id="apellido" class="form-control input-sm" placeholder="Apellido de la persona">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <input type="email" name="email" id="email" class="form-control input-sm" placeholder="Email de la persona">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
